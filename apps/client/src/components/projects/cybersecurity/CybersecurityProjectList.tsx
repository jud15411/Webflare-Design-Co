...
import { CybersecurityProjectCard } from './CybersecurityProjectCard'; // <--- NEW IMPORT
import {
  type Project,
...
import './CybersecurityProjectList.css'; // Specific Cybersecurity styles
...
export const CybersecurityProjectList: React.FC = () => {
  ...
  return (
    <div className="page-container security-page-container">
      ...
      <div className="security-metrics-panel metrics-panel">
        <div>
            <p className="metric-label">Total Projects</p>
            <p className="metric-value">{projects.length}</p>
        </div>
        <div>
            <p className="metric-label">High-Risk Findings</p>
            <p className="metric-value metric-bad">14</p> {/* Placeholder Value */}
        </div>
        <div>
            <p className="metric-label">Next Audit Due</p>
            <p className="metric-value">2026-03-15</p>
        </div>
      </div>
